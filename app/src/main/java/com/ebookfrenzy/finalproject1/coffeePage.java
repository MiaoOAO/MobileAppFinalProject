...
*/
        ...
        coffeeItems.add(new coffeeItem(R.drawable.cappuccino, "cappuccino", "3", "1"));
        coffeeItems.add(new coffeeItem(R.drawable.cappuccino, "cappuccino", "4", "1"));
        coffeeItems.add(new coffeeItem(R.drawable.cappuccino, "cappuccino", "5", "1"));
